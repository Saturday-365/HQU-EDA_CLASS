...
-- y	=>  Location: PIN_32,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
ARCHITECTURE structure OF Class_001 IS
...
-- Equation(s):
-- \y~0_combout\ = (\s~combout\ & (\b~combout\)) # (!\s~combout\ & ((\a~combout\)))
